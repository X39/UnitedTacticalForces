...
namespace X39.UnitedTacticalForces.Api.Data.Migrations
{
    ...
    [Migration("20230720152608_AddingSupportForCompositeModPacks")]
    partial class AddingSupportForCompositeModPacks
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("X39.UnitedTacticalForces.Api.Data.Authority.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            PrimaryKey = 32L,
                            Category = "Server",
                            Identifier = "server-logs-clear",
                            Title = "Server clear logs"
                        },
                        new
                        {
                            PrimaryKey = 33L,
                            Category = "User",
                            Identifier = "user-view-discord",
                            Title = "View Discord data of user"
                        });
                });
