...
{
    public GameServerRepositoryImpl(HttpClient httpClient, BaseUrl baseUrl)
        : base(httpClient, baseUrl) { }

    public async Task<long> GetGameServerCountAsync(CancellationToken cancellationToken = default)
    {
        return await Client.GameServersAllCountAsync(cancellationToken).ConfigureAwait(false);
    }
    ...
    )
    {
        if (gameServer.PrimaryKey is null)
            throw new ArgumentException(Language.Exception_GameServer_PrimaryKey_is_null, nameof(gameServer));
        var result = await Client
                           .GameServersConfigurationDefinitionsAsync(gameServer.PrimaryKey.Value, cancellationToken)
    ...
    )
    {
        if (gameServer.PrimaryKey is null)
            throw new ArgumentException(Language.Exception_GameServer_PrimaryKey_is_null, nameof(gameServer));
        var result = await Client.GameServersConfigurationGetAsync(gameServer.PrimaryKey.Value, cancellationToken)
                                 .ConfigureAwait(false);
        return result.ToImmutableArray();
    }
    ...
    {
        var gameServers = await Client.GameServersAllAsync(cancellationToken).ConfigureAwait(false);
    ...
    )
    {
        if (gameServer.PrimaryKey is null)
            throw new ArgumentException(Language.Exception_GameServer_PrimaryKey_is_null, nameof(gameServer));
        var logsCount = await Client
                              .GameServersLogsCountAsync(
                                  gameServer.PrimaryKey.Value,
                                  referenceTimeStamp,
                                  cancellationToken
                              )
    ...
    {
        var gameServer = await Client.GameServersAsync(gameServerId, cancellationToken).ConfigureAwait(false);
        return gameServer;
    }
    ...
    )
    {
        if (gameServer.PrimaryKey is null)
            throw new ArgumentException(Language.Exception_GameServer_PrimaryKey_is_null, nameof(gameServer));
        await Client.GameServersRenameAsync(gameServer.PrimaryKey.Value, title, cancellationToken)
                    .ConfigureAwait(false);
    }
    ...
    )
    {
        if (gameServer.PrimaryKey is null)
            throw new ArgumentException(Language.Exception_GameServer_PrimaryKey_is_null, nameof(gameServer));
        if (modPackDefinition.PrimaryKey is null)
            throw new ArgumentException(
                Language.Exception_ModPackDefinition_PrimaryKey_is_null,
                nameof(modPackDefinition)
            );
        await Client.GameServersModPackSetAsync(
                        gameServer.PrimaryKey.Value,
                        (int) modPackDefinition.PrimaryKey.Value,
                        cancellationToken
                    )
                    .ConfigureAwait(false);
    }

    public async Task ClearModPackAsync(GameServer gameServer, CancellationToken cancellationToken = default)
    {
        if (gameServer.PrimaryKey is null)
            throw new ArgumentException(Language.Exception_GameServer_PrimaryKey_is_null, nameof(gameServer));
        await Client.GameServersModPackClearAsync(gameServer.PrimaryKey.Value, cancellationToken).ConfigureAwait(false);
    }
    ...
    {
        var gameServerControllers =
            await Client.GameServersAllControllersAsync(cancellationToken).ConfigureAwait(false);
    ...
    public async Task DeleteGameServerAsync(GameServer gameServer, CancellationToken cancellationToken = default)
    {
        if (gameServer.PrimaryKey is null)
            throw new ArgumentException(Language.Exception_GameServer_PrimaryKey_is_null, nameof(gameServer));
        await Client.GameServersDeletePostAsync(gameServer.PrimaryKey.Value, cancellationToken).ConfigureAwait(false);
    }
    ...
    )
    {
        if (gameServer.PrimaryKey is null)
            throw new ArgumentException(Language.Exception_GameServer_PrimaryKey_is_null, nameof(gameServer));
        return await Client.GameServersStartAsync(gameServer.PrimaryKey.Value, cancellationToken).ConfigureAwait(false);
    }
    ...
    )
    {
        if (gameServer.PrimaryKey is null)
            throw new ArgumentException(Language.Exception_GameServer_PrimaryKey_is_null, nameof(gameServer));
        return await Client.GameServersStopAsync(gameServer.PrimaryKey.Value, cancellationToken).ConfigureAwait(false);
    }
    ...
    )
    {
        ...
        if (gameFolder.Identifier is null)
            throw new ArgumentException(Language.Exception_GameFolder_Identifier_is_null, nameof(gameFolder));
        var folders = await Client
                            .GameServersFilesAsync(
                                gameServer.PrimaryKey.Value,
    ...
    )
    {
        ...
        if (gameFolder.Identifier is null)
            throw new ArgumentException(Language.Exception_GameFolder_Identifier_is_null, nameof(gameFolder));
        await Client.GameServersUploadAsync(gameServer.PrimaryKey.Value, gameFolder.Identifier, file, cancellationToken)
                    .ConfigureAwait(false);
    }
    ...
    )
    {
        ...
        if (gameFileInfo.Name is null)
            throw new ArgumentException(Language.Exception_GameFileInfo_Name_is_null, nameof(gameFolder));
    ...
    public async Task ClearAsync(GameServer gameServer, CancellationToken cancellationToken = default)
    {
        if (gameServer.PrimaryKey is null)
            throw new ArgumentException(Language.Exception_GameServer_PrimaryKey_is_null, nameof(gameServer));
        await Client.GameServersLogsClearAsync(gameServer.PrimaryKey.Value, cancellationToken).ConfigureAwait(false);
    }
}
