...
public class EventSlot
{
    ...
    /// <summary>
    /// The user assigned to this event slot, if any.
    /// </summary>
    [ForeignKey(nameof(AssignedToFk))]
    public User? AssignedTo { get; set; }

    /// <summary>
    /// Represents the foreign key to the assigned user.
    /// Corresponds to the <see cref="User"/> entity that has been assigned to this event slot.
    /// </summary>
    public Guid? AssignedToFk { get; set; }

    /// <summary>
    /// Represents an event entity, identifiable by its unique constraints and index properties.
    /// </summary>
    [ForeignKey(nameof(EventFk))]
    public Event? Event { get; set; }

    /// <summary>
    /// Represents the foreign key linking to the associated event.
    /// </summary>
