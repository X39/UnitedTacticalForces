...
namespace X39.UnitedTacticalForces.Api.Data.Migrations
{
    ...
    [Migration("20231218231323_ChangingFromClaimsOnlyToRolesAndClaims")]
    partial class ChangingFromClaimsOnlyToRolesAndClaims
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClaimRole", b =>
                {
                    b.Property<long>("ClaimsPrimaryKey")
                        .HasColumnType("bigint");

                    b.Property<long>("RolesPrimaryKey")
                        .HasColumnType("bigint");

                    b.HasKey("ClaimsPrimaryKey", "RolesPrimaryKey");

                    b.HasIndex("RolesPrimaryKey");
            ...
            modelBuilder.Entity("ClaimUser", b =>
                {
                    ...
                    b.HasKey("ClaimsPrimaryKey", "UsersPrimaryKey");
            ...
            modelBuilder.Entity("ModPackDefinitionModPackRevision", b =>
                {
                    b.Property<long>("ModPackDefinitionsPrimaryKey")
                        .HasColumnType("bigint");

                    b.Property<long>("ModPackRevisionsPrimaryKey")
                        .HasColumnType("bigint");

                    b.HasKey("ModPackDefinitionsPrimaryKey", "ModPackRevisionsPrimaryKey");

                    b.HasIndex("ModPackRevisionsPrimaryKey");

                    b.ToTable("ModPackDefinitionModPackRevision");
                });
            ...
            modelBuilder.Entity("X39.UnitedTacticalForces.Api.Data.Authority.Claim", b =>
                {
                    ...
                    b.HasIndex("Identifier", "Value", "ValueType")
                        .IsUnique();
            ...
            modelBuilder.Entity("ClaimRole", b =>
                {
                    b.HasOne("X39.UnitedTacticalForces.Api.Data.Authority.Claim", null)
                        .WithMany()
                        .HasForeignKey("ClaimsPrimaryKey")
            ...
            modelBuilder.Entity("ModPackDefinitionModPackRevision", b =>
                {
                    b.HasOne("X39.UnitedTacticalForces.Api.Data.Core.ModPackDefinition", null)
                        .WithMany()
                        .HasForeignKey("ModPackDefinitionsPrimaryKey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("X39.UnitedTacticalForces.Api.Data.Core.ModPackRevision", null)
                        .WithMany()
                        .HasForeignKey("ModPackRevisionsPrimaryKey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("X39.UnitedTacticalForces.Api.Data.Authority.User", b =>
                {
                    b.OwnsOne("X39.UnitedTacticalForces.Api.Data.Authority.Extern.DiscordUser", "Discord", b1 =>
                        {
                            b1.Property<Guid>("UserPrimaryKey")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("UserPrimaryKey");

                            b1.ToTable("Users");

                            b1.WithOwner()
                                .HasForeignKey("UserPrimaryKey");
                        });

                    b.OwnsOne("X39.UnitedTacticalForces.Api.Data.Authority.Extern.SteamUser", "Steam", b1 =>
                        {
                            b1.Property<Guid>("UserPrimaryKey")
                                .HasColumnType("uuid");

                            b1.Property<decimal>("Id64")
                                .HasColumnType("numeric(20,0)");
            ...
            modelBuilder.Entity("X39.UnitedTacticalForces.Api.Data.Core.ModPackRevision", b =>
                {
                    b.HasOne("X39.UnitedTacticalForces.Api.Data.Core.ModPackDefinition", "Definition")
                        .WithMany("ModPackRevisionsOwned")
            ...
            modelBuilder.Entity("X39.UnitedTacticalForces.Api.Data.Core.ModPackDefinition", b =>
                {
                    b.Navigation("ModPackRevisionsOwned");
                });
