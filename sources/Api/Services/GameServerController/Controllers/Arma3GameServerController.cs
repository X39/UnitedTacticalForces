...
public sealed class Arma3GameServerController : SteamGameServerControllerBase, IGameServerControllerCreatable
{
    ...
    public override IEnumerable<ConfigurationEntryDefinition> GetConfigurationEntryDefinitions(CultureInfo cultureInfo)
    {
        ...
        yield return new ConfigurationEntryDefinition(false, RealmServerCfg, EConfigurationEntryKind.Selection, "allowedFilePatching", null, Language.ResourceManager.GetString(nameof(Language.ServerController_Arma3_ServerCfg_ServerBehavior), cultureInfo) ?? string.Empty, Language.ResourceManager.GetString(nameof(Language.ServerController_Arma3_ServerCfg_AllowedFilePatching_Title), cultureInfo) ?? string.Empty, Language.ResourceManager.GetString(nameof(Language.ServerController_Arma3_ServerCfg_AllowedFilePatching_Description), cultureInfo) ?? string.Empty, DefaultValue: "0", AllowedValues: [new(Language.ResourceManager.GetString(nameof(Language.ServerController_Arma3_ServerCfg_AllowedFilePatching_Value0_Name), cultureInfo) ?? string.Empty, "0", Language.ResourceManager.GetString(nameof(Language.ServerController_Arma3_ServerCfg_AllowedFilePatching_Value0_Description), cultureInfo) ?? string.Empty), new(Language.ResourceManager.GetString(nameof(Language.ServerController_Arma3_ServerCfg_AllowedFilePatching_Value1_Name), cultureInfo) ?? string.Empty, "1", Language.ResourceManager.GetString(nameof(Language.ServerController_Arma3_ServerCfg_AllowedFilePatching_Value1_Description), cultureInfo) ?? string.Empty), new(Language.ResourceManager.GetString(nameof(Language.ServerController_Arma3_ServerCfg_AllowedFilePatching_Value2_Name), cultureInfo) ?? string.Empty, "2", Language.ResourceManager.GetString(nameof(Language.ServerController_Arma3_ServerCfg_AllowedFilePatching_Value2_Description), cultureInfo) ?? string.Empty)]);
        ...
        yield return new ConfigurationEntryDefinition(false, RealmServerCfg, EConfigurationEntryKind.String, "forcedDifficulty", null, Language.ResourceManager.GetString(nameof(Language.ServerController_Arma3_ServerCfg_OtherOptions), cultureInfo) ?? string.Empty, Language.ResourceManager.GetString(nameof(Language.ServerController_Arma3_ServerCfg_ForcedDifficulty_Title), cultureInfo) ?? string.Empty, Language.ResourceManager.GetString(nameof(Language.ServerController_Arma3_ServerCfg_ForcedDifficulty_Description), cultureInfo) ?? string.Empty);
    ...
    private StreamWriter CreateBattlEyeConfigurationWriter()
    {
        ...
        return new StreamWriter(
            new MultiStream([Create(BattlEyeConfigurationPath), Create(BattlEyeConfigurationX64Path)]),
            Encoding.UTF8);
    }
    ...
    protected override async Task DoUpdateConfigurationAsync()
    {
        ...
        foreach (var group in configurationEntries.GroupBy(q => q.Realm))
        {
            ...
            await WritePathSegmentsIfNeeded(streamWriter, [])
                .ConfigureAwait(false);
        }
    }
